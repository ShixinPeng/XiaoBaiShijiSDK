#
#  Be sure to run `pod spec lint XBSJCode.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "pengshixin"
  # s.authors            = { "pengshixin" => "shixinpeng0429@163.com" }
  # s.social_media_url   = "http://twitter.com/pengshixin"
  ...
  s.source       = { :git => "https://github.com/ShixinPeng/XiaobaiShijiSDK.git", :tag => "0.0.1" }
